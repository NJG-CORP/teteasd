...
contract ERC20Token is Context, IERC20, LockToken {
    using SafeMath for uint256;

    struct Fees {
        uint256 liquidityFee;
        uint256 marketingWalletFee;
        uint256 devWalletFee;
    }
    ...
    uint256 public _tfrLiquidityFee;
    uint256 public _tfrMarketingFee;
    uint256 public _tfrDevFee;
    ...
    constructor(
        ...
        Fees memory buyFees_,
        Fees memory sellFees_,
        Fees memory transferFees_,
        string memory name_,
        ...
        newOwner = owner_;
        router = router_;
        marketingAddress = marketingWallet_;
        devAddress = devWallet_;
        _tTotal = totalSupply_;
        _rTotal = (type(uint256).max - (type(uint256).max % totalSupply_));
        _maxTxAmount = _tTotal.div(1000).mul(maxTxPercent_);
        _walletHoldingMaxLimit = _tTotal.div(1000).mul(maxWalletPercent_);
        minimumTokensBeforeSwap = swapThreshold_;
        {
            _buyLiquidityFee = buyFees_.liquidityFee;
            _buyMarketingFee = buyFees_.marketingWalletFee;
            _buyDevFee = buyFees_.devWalletFee;
            buyTotalFee = buyFees_.liquidityFee + buyFees_.marketingWalletFee + buyFees_.devWalletFee;
            buyFeesBackup = [buyFees_.liquidityFee, buyFees_.marketingWalletFee, buyFees_.devWalletFee];
        }
        {
            _sellLiquidityFee = sellFees_.liquidityFee;
            _sellMarketingFee = sellFees_.marketingWalletFee;
            _sellDevFee = sellFees_.devWalletFee;
            sellTotalFee = sellFees_.liquidityFee + sellFees_.marketingWalletFee + sellFees_.devWalletFee;
        }
        {
            _tfrLiquidityFee = transferFees_.liquidityFee;
            _tfrMarketingFee = transferFees_.marketingWalletFee;
            _tfrDevFee = transferFees_.devWalletFee;
            transferTotalFee = transferFees_.liquidityFee + transferFees_.marketingWalletFee + transferFees_.devWalletFee;
        }
        _name = name_;
        _symbol = symbol_;
        ...
        includeToWhiteList(owner_);
        _isExcludedFromWhale[owner_] = true;
